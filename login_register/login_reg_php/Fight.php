...
<div id="finalize-form" style="display: none;">
    <form method="POST">
        ...
        <label for="video_link">Link del Video:</label> <!-- Agregado -->
        <input type="url" id="video_link" name="video_link" placeholder="https://example.com/video" required><br> <!-- Agregado -->
